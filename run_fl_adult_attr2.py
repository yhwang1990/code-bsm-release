from facility_loc.algo_fl import greedy_fl, saturate_fl, bsm_tsgreedy_fl, bsm_saturate_fl, calc_obj_vals, read_items, read_users, read_attr, generate_benefit_mat

items = read_items('./data/adult/adult-features.txt')
users = read_users('./data/adult/adult-features.txt')
attrs, groups = read_attr('./data/adult/adult-attr2.txt')
output_file = open('./results/fl_results_adult-attr2.csv', 'a')
